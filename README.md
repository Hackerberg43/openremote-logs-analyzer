...
- A lightweight, portable, log analyzer for OpenRemote manager trace logs. Meant for analyzing trace logs generated by the Openremote manager stored in the manager volume /logs folder.
- :star: No installation required - just open in your browser!
